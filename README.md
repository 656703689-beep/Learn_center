...
| 路线 | 当前进度 | 从这里开始 |
| --- | --- | --- |
| Python for AI | 第二十一课：读取 choices 里的 AI 回复已完成 | [学习使命](Python/MISSION.md) · [第二十一课](Python/lessons/0021-choices-list-response.html) · [choices 速查](Python/reference/python-choices-list-response.html) · [学习记录](Python/NOTES.md) |
