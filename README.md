...
| 路线 | 当前进度 | 从这里开始 |
| --- | --- | --- |
| Python for AI | 已完成第二十四课：把多条 content 收集进列表 | [学习使命](Python/MISSION.md) · [第二十四课](Python/lessons/0024-collect-ai-contents.html) · [收集 content 速查](Python/reference/python-collect-ai-contents.html) · [学习记录](Python/NOTES.md) |
